...
from sklearn.ensemble._bagging import BaseBagging, BaggingClassifier, BaggingRegressor
...
class SequentiallyBootstrappedBaseBagging(BaseBagging, metaclass=ABCMeta):
    ...
    def fit(self, X, y, time_index, sample_weight=None):
        ...
        self : object
        """
        self.X_time_index = time_index # remember X for future time sampling
